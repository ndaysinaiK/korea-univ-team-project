        ...
        <div className="bg-white rounded-t-3xl shadow-lg w-4/5 sm:w-1/4 mt-20 p-4 ">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                {survey&&<div className="border border-black w-6/6 p-2 mt-3">
                    ...
                    <div className="border border-black p-2 mt-3"> 
                        ...
                        <div className="flex flex-col  text-xs"> 
                            ...
                            <div className="flex items-center justify-center mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="1"/></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="1" /></p>
                            </div>
                            
                            <p className="mt-3">2. 기분이 가라앉거나, 우울하거나, 희망이 없음</p>
                            <div className="flex items-center justify-center mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="2" /></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="2"/></p>
                            </div>
                            <p className="mt-3">3. 잠이 들거나 계속 잠을 자는 것이 어려움, 또는 잠을 너무 많이 잠</p>
                            <div className="flex items-center justify-center  mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="3"/></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="3" /></p>
                            </div>

                            <p className="mt-3">4. 피곤하다고 느끼거나 기운이 거의 없음</p>
                            <div className="flex items-center justify-center  mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="4" /></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="4"/></p>
                            </div>
                            <p className="mt-3">5. 입맛이 없거나 과식을 함</p>
                            <div className="flex items-center justify-center  mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="5" /></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="5" /></p>
                            </div>
                            <p className="mt-3">6. 자신을 부정적으로 봄, 혹은 자신이 실패자라고 느끼거나 자신 또는 가족을 실망시킴</p>
                            <div className="flex items-center justify-center  mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="6"/></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="6" /></p>
                            </div>
                            <p className="mt-3">7. 신문을 읽거나 텔레비전 보는 것과 같은 일에 집중하는 것이 어려움</p>
                            <div className="flex items-center justify-center  mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="7"/></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="7" /></p>
                            </div>
                            <p className="mt-3">8. 다른 사람들이 주목할 정도로 너무 느리게 움직이거나 말을 함, 또는 반대로 평상시보다 많이 움직여서 너무 안절부절 못하 거나 들떠 있음</p>
                            <div className="flex items-center justify-center  mt-2 mb-4">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="8" /></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="8" /></p>
                            </div>
                            <p className="mt-3">9. 자신이 죽는 것이 더 낫다고 생각하거나 어떤 식으로든 자신을 해칠 것이라고 생각함</p>
                            <div className="flex items-center justify-center  mt-2">
                                <p className="flex items-center justify-center mr-10"><b className="mr-1">Yes</b><input type="radio" name="9" /></p>
                                <p className="flex items-center justify-center"><b className="mr-1">No</b><input type="radio" name="9" /></p>
                            </div>
                    ...
                    <div className="flex items-center justify-center bg-green-600 mt-3 p-4 text-white border border-black cursor-pointer">
                        <p>설문완료</p>
                    </div>
